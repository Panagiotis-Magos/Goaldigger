...
Β) Η εφαρμογή είναι συμβατή με androidAPI 34 και πάνω. Συγκεκριμμένα χτίστηκε σε Android Pixel 8 Pro με image Android 14.0 Upsidedowncake x86_64, και έχει ελεγχθεί και με Android 15.0  Pixel 9 συσκευές.  Εχει επαληθευθεί μόνο σε συσκευές με Google API. Το repository της εφαρμογής βρίσκεται εδώ https://github.com/Panagiotis-Magos/GoalDigger.
